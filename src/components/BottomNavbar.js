...
import {
    HouseFill,
    PeopleFill,
    ChatDotsFill // Added for Connections History
} from 'react-bootstrap-icons';
import { handleExcelImport } from '../services/excelService';

const menuItems = [
    { to: '/dashboard', label: 'Dashboard', icon: <HouseFill size={25} /> },
    { to: '/connections', label: 'Connections', icon: <ChatDotsFill size={25} /> }, // Added Connections
    { to: '/import', label: 'Import', icon: <PeopleFill size={25} />, isImport: true }, // Added isImport flag
];
